...
-- PRODUCTS
-- ------------------------------------------------------------
INSERT INTO products (product_id, category_id, name, price, is_active) VALUES
-- Entrantes
(1,  1, 'Croquetas de jamón (6 ud)',     7.50,  true),
(2,  1, 'Patatas bravas',                5.00,  true),
(3,  1, 'Tabla de ibéricos',            14.00,  true),
-- Platos principales
(4,  2, 'Secreto ibérico a la brasa',   16.50,  true),
(5,  2, 'Merluza en salsa verde',       15.00,  true),
(6,  2, 'Carrillada de cerdo',          14.50,  true),
(7,  2, 'Hamburguesa premium',          13.00,  true),
-- Postres
(8,  3, 'Tarta de queso',               5.50,  true),
(9,  3, 'Brownie con helado',           5.00,  true),
(10, 3, 'Flan casero',                  4.00,  true),
-- Bebidas
(11, 4, 'Agua mineral 50cl',            1.50,  true),
(12, 4, 'Refresco lata',                2.50,  true),
(13, 4, 'Cerveza caña',                 2.00,  true),
(14, 4, 'Vino de la casa (copa)',        2.50,  true),
(15, 4, 'Zumo natural',                 3.00,  true),
-- Menú del día (producto inactivo de ejemplo)
(16, 5, 'Menú completo',               12.00,  false);
